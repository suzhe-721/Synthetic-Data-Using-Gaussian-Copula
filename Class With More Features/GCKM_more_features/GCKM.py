...
class GaussianCopulaKmeansSynthesizer:
    ...
    def optimal_clusters_dynamic(self):
        ...
        cov_matrix = np.cov(standard_normal_df, rowvar=False)
    ...
    def get_Kmeans(self):
        ...
        kmeans = KMeans(n_clusters=self.num_of_clusters, random_state=0)
        kmeans.fit(self.standard_gaussian_df)
        ...
        self.gmm.fit(self.standard_gaussian_df)
    ...
    def generate_data(self):
        ...
        self.synthetic_data_raw = pd.DataFrame(synthetic_overall, columns=column_names)
